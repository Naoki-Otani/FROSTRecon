...
# ========= path settings =========
ROOT_IN_DIR="/group/nu/ninja/work/otani/FROSTReconData/BM_FROST/BMdeadpln_fix/rootfile_after_HitConverter"
ROOT_OUT_DIR="/group/nu/ninja/work/otani/FROSTReconData/BM_FROST/BMdeadpln_fix/rootfile_after_TrackMatch"
