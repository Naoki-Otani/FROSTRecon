...
# ========= path settings =========
BM_DIR="/group/nu/ninja/work/otani/FROSTReconData/BMdata/BMdeadpln_fix/4-BMPMrecon/track_merged"
FROST_DIR="/group/nu/ninja/work/otani/FROSTReconData/FROSTdata"

ROOT_OUT_DIR="/group/nu/ninja/work/otani/FROSTReconData/BM_FROST/BMdeadpln_fix/rootfile_after_HitConverter"
