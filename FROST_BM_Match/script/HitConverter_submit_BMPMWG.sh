...
# ========= path settings =========
BM_DIR="/group/nu/ninja/work/otani/FROSTReconData/BMPMWGdata"
FROST_DIR="/group/nu/ninja/work/otani/FROSTReconData/FROSTdata"

ROOT_OUT_DIR="/group/nu/ninja/work/otani/FROSTReconData/BM_FROST_BMWGPM/1-rootfile_after_HitConverter"
