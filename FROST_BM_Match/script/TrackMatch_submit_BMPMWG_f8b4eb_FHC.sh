...
# ========= path settings =========
ROOT_IN_DIR="/group/nu/ninja/work/otani/FROSTReconData/BM_FROST_BMWGPM_f8b4eb/1-rootfile_after_HitConverter/FHC"
ROOT_OUT_DIR="/group/nu/ninja/work/otani/FROSTReconData/BM_FROST_BMWGPM_f8b4eb/2-rootfile_after_TrackMatch_externalfit_PMandDWG/FHC"
