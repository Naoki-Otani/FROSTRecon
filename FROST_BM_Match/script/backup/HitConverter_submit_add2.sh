...
# ========= path settings =========
BM_DIR="/group/nu/ninja/work/otani/FROSTReconData/BMdata/4-BMPMrecon_added2/track_merged"
FROST_DIR="/group/nu/ninja/work/otani/FROSTReconData/FROSTdata"

ROOT_OUT_DIR="/group/nu/ninja/work/otani/FROSTReconData/BM_FROST/rootfile_after_HitConverter_added2"
