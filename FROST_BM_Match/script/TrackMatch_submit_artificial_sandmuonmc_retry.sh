...
# ========= path settings =========
ROOT_IN_DIR="/group/nu/ninja/work/otani/Artificial_sandmuonMC_retry/Artificial_sandmuonMC/5-FROSTRecon"
ROOT_OUT_DIR="/group/nu/ninja/work/otani/Artificial_sandmuonMC_retry/Artificial_sandmuonMC/6-TrackMatch_externalfit_PMandDWG"
