...
outDirArg=(
  ...
  "/group/nu/ninja/work/otani/FROSTReconData/MapFunc/mcdata/singlehit/aftermppccorrection/y"
  "/group/nu/ninja/work/otani/FROSTReconData/MapFunc/mcdata/twohit/aftermppccorrection/x"
  "/group/nu/ninja/work/otani/FROSTReconData/MapFunc/mcdata/twohit/aftermppccorrection/y"
)
