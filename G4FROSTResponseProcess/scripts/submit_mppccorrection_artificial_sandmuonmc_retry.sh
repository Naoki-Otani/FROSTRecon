...
INPUT_DIR="/group/nu/ninja/work/otani/FROSTReconData/Artificial_sandmuonMC_retry/3-FROSTResponse"
OUTPUT_DIR="/group/nu/ninja/work/otani/FROSTReconData/Artificial_sandmuonMC_retry/4-FROSTResponse_mppccorrection"
