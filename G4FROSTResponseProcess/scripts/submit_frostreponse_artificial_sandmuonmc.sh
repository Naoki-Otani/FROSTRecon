...
INPUT_DIR="/group/nu/ninja/work/otani/FROSTReconData/Artificial_sandmuonMC/2-recon/track"
OUTPUT_DIR="/group/nu/ninja/work/otani/FROSTReconData/Artificial_sandmuonMC/3-FROSTResponse"
