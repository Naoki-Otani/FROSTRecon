...
# ========= path settings =========
BM_DIR="/group/nu/ninja/work/otani/FROSTReconData/BMdata/2-BMBSD_added_fixed"
# BM_DIR="/hsm/nu/wagasci/dhirata/bm_recon/2-BMBSD"
PM_DIR="/group/nu/ninja/work/otani/FROSTReconData/BMdata/4-PMBSD_BMformat_added"
OUT_DIR="/group/nu/ninja/work/otani/FROSTReconData/BMdata/3-BMPMconverter_added/out"
LOG_DIR="/group/nu/ninja/work/otani/FROSTReconData/BMdata/3-BMPMconverter_added/log"
ROOT_OUT_DIR="/group/nu/ninja/work/otani/FROSTReconData/BMdata/3-BMPMconverter_added"
TMP_DIR="/group/nu/ninja/work/otani/FROSTReconData/BMdata/3-BMPMconverter_added/tmp"
