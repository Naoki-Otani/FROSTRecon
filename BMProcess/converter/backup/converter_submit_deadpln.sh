...
# ========= path settings =========
BM_DIR="/group/nu/ninja/work/otani/FROSTReconData/BMdata/2-BMBSD_deadpln"
# BM_DIR="/hsm/nu/wagasci/dhirata/bm_recon/2-BMBSD"
PM_DIR="/group/nu/ninja/work/otani/FROSTReconData/BMdata/4-PMBSD_BMformat"
OUT_DIR="/group/nu/ninja/work/otani/FROSTReconData/BMdata/3-BMPMconverter_deadpln/out"
LOG_DIR="/group/nu/ninja/work/otani/FROSTReconData/BMdata/3-BMPMconverter_deadpln/log"
ROOT_OUT_DIR="/group/nu/ninja/work/otani/FROSTReconData/BMdata/3-BMPMconverter_deadpln"
TMP_DIR="/group/nu/ninja/work/otani/FROSTReconData/BMdata/3-BMPMconverter_deadpln/tmp"
