...
# ========= path settings =========
VERTEX_DIR="/group/nu/ninja/work/otani/FROSTReconData/BMdata/3-BMPMrecon/vertex/with_deadplane_correction"

TRACK_DIR="/group/nu/ninja/work/otani/FROSTReconData/BMdata/3-BMPMrecon/track/with_deadplane_correction"
