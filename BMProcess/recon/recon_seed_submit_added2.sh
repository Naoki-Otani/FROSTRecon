...
# ========= path settings =========
CONVERTED_DIR="/group/nu/ninja/work/otani/FROSTReconData/BMdata/3-BMPMconverter_divided_added2"

SEED_DIR="/group/nu/ninja/work/otani/FROSTReconData/BMdata/4-BMPMrecon_added2/seed"
