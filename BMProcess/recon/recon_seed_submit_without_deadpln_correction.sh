...
# ========= path settings =========
CONVERTED_DIR="/group/nu/ninja/work/otani/FROSTReconData/WGBMdata/2-BMPMWGconverter_divided/without_deadplane_correction"

SEED_DIR="/group/nu/ninja/work/otani/FROSTReconData/WGBMdata/3-BMPMWGrecon/seed/without_deadplane_correction"
