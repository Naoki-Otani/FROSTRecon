...
# ========= path settings =========
CONVERTED_DIR="/group/nu/ninja/work/otani/FROSTReconData/BMdata/3-BMPMconverter_divided_added"

SEED_DIR="/group/nu/ninja/work/otani/FROSTReconData/BMdata/4-BMPMrecon_added/seed"
