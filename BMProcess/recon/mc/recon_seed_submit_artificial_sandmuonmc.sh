...
# ========= path settings =========
WAGASCIMC_DIR="/group/nu/ninja/work/otani/FROSTReconData/Artificial_sandmuonMC/1-WagasciMC"

SEED_DIR="/group/nu/ninja/work/otani/FROSTReconData/Artificial_sandmuonMC/2-recon/seed"
...
for wagascimc_file in "$WAGASCIMC_DIR"/b2mc_artificial_sandmuon_*.root; do
    ...
    suffix="${converted_base#b2mc_artificial_sandmuon_}"

    out_file="$OUT_DIR/artificial_sandmuonmc_seed_${suffix%.root}.out"
    log_file="$LOG_DIR/artificial_sandmuonmc_seed_${suffix%.root}.log"
    seed_file="$SEED_DIR/artificial_sandmuonmc_seed_$suffix"
