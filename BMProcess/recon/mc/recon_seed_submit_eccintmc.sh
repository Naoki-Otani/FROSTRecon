...
# ========= path settings =========
WAGASCIMC_DIR="/group/nu/ninja/work/otani/FROSTReconData/ECCintMC/1-WagasciMC"

SEED_DIR="/group/nu/ninja/work/otani/FROSTReconData/ECCintMC/2-recon/seed"
...
for wagascimc_file in "$WAGASCIMC_DIR"/b2mc_eccint_*.root; do
    ...
    suffix="${converted_base#b2mc_eccint_}"

    out_file="$OUT_DIR/eccintmc_seed_${suffix%.root}.out"
    log_file="$LOG_DIR/eccintmc_seed_${suffix%.root}.log"
    seed_file="$SEED_DIR/eccintmc_seed_$suffix"
