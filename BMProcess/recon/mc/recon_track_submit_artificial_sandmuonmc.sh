...
# ========= path settings =========
VERTEX_DIR="/group/nu/ninja/work/otani/FROSTReconData/Artificial_sandmuonMC/2-recon/vertex"

TRACK_DIR="/group/nu/ninja/work/otani/FROSTReconData/Artificial_sandmuonMC/2-recon/track"
