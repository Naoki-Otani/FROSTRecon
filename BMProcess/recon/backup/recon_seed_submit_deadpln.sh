...
# ========= path settings =========
CONVERTED_DIR="/group/nu/ninja/work/otani/FROSTReconData/BMdata/BMdeadpln_fix/3-BMPMconverter_divided"

SEED_DIR="/group/nu/ninja/work/otani/FROSTReconData/BMdata/BMdeadpln_fix/4-BMPMrecon/seed"
