...
# ========= path settings =========
VERTEX_DIR="/group/nu/ninja/work/otani/FROSTReconData/BMdata/4-BMPMrecon_added2/vertex"

TRACK_DIR="/group/nu/ninja/work/otani/FROSTReconData/BMdata/4-BMPMrecon_added2/track"
