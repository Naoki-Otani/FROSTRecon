...
# ========= path settings =========
VERTEX_DIR="/group/nu/ninja/work/otani/FROSTReconData/BMdata/4-BMPMrecon_added/vertex"

TRACK_DIR="/group/nu/ninja/work/otani/FROSTReconData/BMdata/4-BMPMrecon_added/track"
