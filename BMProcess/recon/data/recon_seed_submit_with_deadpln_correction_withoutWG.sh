...
# ========= path settings =========
CONVERTED_DIR="/group/nu/ninja/work/otani/FROSTReconData/BMdata/2-BMPMconverter_divided/with_deadplane_correction"

SEED_DIR="/group/nu/ninja/work/otani/FROSTReconData/BMdata/3-BMPMrecon/seed/with_deadplane_correction"
