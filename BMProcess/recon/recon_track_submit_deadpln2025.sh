...
# ========= path settings =========
VERTEX_DIR="/group/nu/ninja/work/otani/FROSTReconData/BMdata/4-BMPMrecon_deadpln2025/vertex"

TRACK_DIR="/group/nu/ninja/work/otani/FROSTReconData/BMdata/4-BMPMrecon_deadpln2025/track"
