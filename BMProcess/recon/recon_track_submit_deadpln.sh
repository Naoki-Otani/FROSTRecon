...
# ========= path settings =========
VERTEX_DIR="/group/nu/ninja/work/otani/FROSTReconData/BMdata/BMdeadpln_fix/4-BMPMrecon/vertex"

TRACK_DIR="/group/nu/ninja/work/otani/FROSTReconData/BMdata/BMdeadpln_fix/4-BMPMrecon/track"
