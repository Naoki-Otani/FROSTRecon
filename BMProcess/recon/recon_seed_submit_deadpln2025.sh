...
# ========= path settings =========
CONVERTED_DIR="/group/nu/ninja/work/otani/FROSTReconData/BMdata/3-BMPMconverter_deadpln_divided"

SEED_DIR="/group/nu/ninja/work/otani/FROSTReconData/BMdata/4-BMPMrecon_deadpln2025/seed"
